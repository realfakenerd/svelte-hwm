var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-w2byww");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "class", "progress-container svelte-w2byww");
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(h2, "class", "svelte-q2zkav");
    			attr(div0, "bp", "grid");
    			attr(button, "bp", "offset-5@md 4@md 12@sm");
    			attr(button, "class", "start svelte-q2zkav");
    ...
    function create_fragment(ctx) {
    	...
    	let current;
    	timer = new Timer({});
    	timer.$on("end", timeEnded);
    	howto = new HowTo({});

    	return {
    		c() {
    			h1 = element("h1");
    			h1.textContent = "Handwashing Machine";
    			t1 = space();
    			...
    			footer.innerHTML = `<h3 class="svelte-4n3h2n"><a href="https://who.int/gpsc/clean_hands_protection/en">Picture Source</a> 
		<a href="https://freesound.org/people/metrostock99/sounds/345086/">Sound Source</a></h3>`;

    			attr(h1, "class", "svelte-4n3h2n");
    		},
    		m(target, anchor) {
